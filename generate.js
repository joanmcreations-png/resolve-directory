...
<header>
  ...
  <nav class="top">
    ...
    <div class="notify-wrap" id="authArea">
      <button class="btn-solid" id="signInBtn">Sign In</button>
      <div class="popover" id="signInPopover">
        ...
        <div class="oauth-row">
          ...
          <button class="btn-oauth" id="githubSignIn">
...
<footer>
  resolve.directory. Built by editors, for editors.<br>Not affiliated with Blackmagic Design.
</footer>
