...
const { grades, categoryIcons, categoryColors, categoryInstall } = require('./data.js');

const outDir = path.join(__dirname, 'grade');
...
<meta property="og:title" content="${escapeHtml(g.name)} — Free ${escapeHtml(g.cat)} for DaVinci Resolve">
...
<meta name="twitter:title" content="${escapeHtml(g.name)} — Free ${escapeHtml(g.cat)} for DaVinci Resolve">
<meta name="twitter:description" content="${escapeHtml(g.desc)}">
...
<script type="application/ld+json">
{
  ...
  "keywords": ${JSON.stringify(g.cat + ', DaVinci Resolve, color grading')}
}
</script>
...
<header>
  ...
  <nav class="top">
    ...
    <div class="notify-wrap">
      <button class="btn-solid" id="submitBtn">Submit a Resource</button>
    ...
    <div class="notify-wrap">
      <button class="btn-solid" id="notifyBtn">Get notified</button>
...
<footer>
  <div class="footer-cols">
    ...
    <div class="footer-col">
      <h3>Contribute</h3>
      <a href="https://github.com/joanmcreations-png/resolve-directory" target="_blank" rel="noopener noreferrer">GitHub</a>
    </div>
  </div>
  <div class="footer-bottom">
    ...
    <a class="footer-social" href="https://github.com/joanmcreations-png/resolve-directory" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M12 .5C5.65.5.5 5.65.5 12c0 5.08 3.29 9.39 7.86 10.91.57.1.78-.25.78-.55v-2.1c-3.2.7-3.87-1.36-3.87-1.36-.52-1.33-1.28-1.69-1.28-1.69-1.04-.71.08-.7.08-.7 1.15.08 1.76 1.18 1.76 1.18 1.02 1.75 2.68 1.24 3.34.95.1-.74.4-1.24.72-1.53-2.56-.29-5.26-1.28-5.26-5.7 0-1.26.45-2.29 1.18-3.09-.12-.29-.51-1.46.11-3.04 0 0 .97-.31 3.18 1.18a11 11 0 0 1 5.8 0c2.2-1.49 3.17-1.18 3.17-1.18.63 1.58.24 2.75.12 3.04.74.8 1.18 1.83 1.18 3.09 0 4.43-2.7 5.4-5.28 5.69.42.36.78 1.07.78 2.16v3.2c0 .3.21.66.79.55A10.51 10.51 0 0 0 23.5 12c0-6.35-5.15-11.5-11.5-11.5z"/></svg>
    </a>
  </div>
...
console.log(`Generated ${grades.length} pages in /grade and updated sitemap.xml`);
