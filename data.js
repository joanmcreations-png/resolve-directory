(function (root) {
  ...
  const rawGrades = [
    ...
    { name: "ColorWheel Free Cinematic PowerGrade", desc: "5+ free cinematic PowerGrade presets for DaVinci Resolve 17, Mac & Windows.", cat: "PowerGrade", tag: "free", cam: "Any", url: "https://colorwheelstore.com/p/free-powergrade-cinematic/" },
    ...
    { name: "PixelTools Free DCTL Toolkit", desc: "Three free DCTL tools for Resolve — Checker, Exposure/Chart and PQ Tester.", cat: "DCTL Tool", tag: "free", cam: "Any", url: "https://pixeltoolspost.com/pages/archived-free-powergrades" },
    ...
    { name: "Panasonic V-Log LUT Library", desc: "Official free LUT library for VariCam, EVA1, S1H and more V-Log cameras.", cat: "Official LUT", tag: "free", cam: "Panasonic", url: "https://na.panasonic.com/us/resource-center/v-log-lut-library" },
    ...
    { name: "RED IPP2 Output Presets", desc: "Official free 3D LUTs for every RED IPP2 output transform combination.", cat: "Official LUT", tag: "free", cam: "RED", url: "https://www.red.com/download/ipp2-output-presets" },
    { name: "RED Creative LUT Kit", desc: "25 free creative LUTs for RED footage by Phil Holland and Eric Weidt.", cat: "Official LUT", tag: "free", cam: "RED", url: "https://www.red.com/download/red-creative-lut-kit" },
